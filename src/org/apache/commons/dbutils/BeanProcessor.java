...
public class BeanProcessor {
     ...
     * @return
     */
    private String getUnderlinePropertyname(String columnName){
    	return StringUtils.replace(columnName, "_", "");
    	//去下划线,小写转大写
...
//        return sb.toString();  
    ...
    protected int[] mapColumnsToProperties(ResultSetMetaData rsmd,
        ...
        for (int col = 1; col <= cols; col++) {
            String columnName = getUnderlinePropertyname(rsmd.getColumnLabel(col));
